...
- With the avatar on, the leftmost 8 columns hold the user's 8×8 avatar and the heatmap shrinks to the remaining 24 columns. Avatar pixels arrive row-major and are written transposed into the column-major panel; get this wrong and the avatar renders mirrored across the diagonal.
